...
// ScreenDrawer
import { StackRoutesAuh } from "./routes.Drawer";
...
function OpenRoutes() {
  ...
  return (
    ...
    >
      ...
      {/* <Stack.Screen
        name="ScreenMoreRecent"
        component={MoreRecent}
        options={{
          headerShown: true,
          headerTitleAlign: 'center',
          headerTitle: () => (
      ...
      {/* <Stack.Screen
        name="ScreenScheduleConsultation"
      ...
      />
      {/* <Stack.Screen
        name="ScreenFilterMoreRecent"
        component={FilterMoreRecent}
        options={{
          headerShown: true,
          headerTitleAlign: 'center',
          headerTitle: () => (
