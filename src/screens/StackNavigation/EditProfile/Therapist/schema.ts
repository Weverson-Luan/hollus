...
const EditProfileSchema = Yup.object().shape({
    ...
    rg: Yup.string().nullable().required('Insira seu RG'),
    cpf: Yup.string().nullable().required('Insira seu CPF'),
    email: Yup.string().email().nullable().required('Insira seu e-mail'),
    sobre: Yup.string().nullable().required("Insira uma informação sobre você"),
    celular: Yup.string().required('Insira seu celular'),
    sobre_consulta: Yup.string().nullable().required("Insira uma informação sobre a consulta"),
