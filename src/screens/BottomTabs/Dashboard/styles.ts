...
export const TextSchedulingDie = styled.Text`
  font-size: ${RFValue(14)}px;
  color: ${({ theme }) => theme.colors.black};
...
`;
export const InfoLineSchedulingStatus = styled.View`
  width: 100%;
  ...
  margin-bottom: 10px;
`;
export const ContentIconStatus = styled.View`
  flex-direction: row;
  align-items: center;
  justify-content: space-between;
`;

export const TextSchedulingStatus = styled.Text`
  font-size: ${RFValue(14)}px;
  color: ${({ theme }) => theme.colors.gray_150};

  margin-left: ${RFValue(10)}px;
`;
export const TextInfoValueSchedulingStatus = styled.Text`
  font-size: ${RFValue(14)}px;
  color: ${({ theme }) => theme.colors.gray_150};
  margin-left: 10px;
`;
